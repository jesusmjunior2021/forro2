...
const SlateCardComponent: React.FC<{ card: SlateCard; onDelete: () => void; onCopy: () => void; }> = ({ card, onDelete, onCopy }) => {
    return (
        <div className="p-4 border-t border-gray-700/50 first:border-t-0 animate-fade-in">
